...
% https://www.overleaf.com/docs?snip_uri=https://raw.githubusercontent.com/divisbyzero/pres-template/refs/heads/main/pres-template481-01.tex&splash=none
...
\newcommand{\probleminfo}[1]{\setlength{\fboxrule}{0.5pt}\fcolorbox{black}{BlueGreen!15}{\footnotesize #1}}%
...
\MySection{MATH 481-01}
% Also, remember:
% Name the file: JaneDoe_2.13.pdf
% Email subject line: MATH 481-01: Presentation problem
